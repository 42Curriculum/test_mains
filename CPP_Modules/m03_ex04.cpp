...
/*   Updated: 2020/05/11 01:30:53 by jjosephi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	while (42)
	{
		std::cout << "Choose : FRAG SCAV  NINJA SUPER?\n";
		...
		{
			std::cout << "Commands available: MELEE RANGED SHOEBOX VH.EXE REPAIR HIT\n";
			std::getline(std::cin, input);
			if (input == "MELEE")
			{
				std::cout << "Please input a target name\n";
				std::getline(std::cin, input);
				super.meleeAttack(input);
			}
			else if (input == "RANGED")
			{
				std::cout << "Please input a target name\n";
				std::getline(std::cin, input);
				super.rangedAttack(input);
			}
			else if (input == "SHOEBOX")
			{
				std::cout << "Which target?\n";
			...
			else if (input == "REPAIR")
			{
				std::cout << "Please input a repair amount\n";
				std::getline(std::cin, input);
				super.beRepaired(std::stoi(input));
			}
			else if (input == "HIT")
			{
				std::cout << "Please input a damage amount\n";
				std::getline(std::cin, input);
				super.takeDamage(std::stoi(input));
			}
			else if (input == "VH.EXE")
			{
				std::cout << "Please input a target name\n";
				std::getline(std::cin, input);
				super.vaulthunter_dot_exe(input);
			}
		}
	}
}